...
public interface SimilarityService {
    ...
    public Result_id simReqProject(String url, String organization, double threshold, int max_number, List<String> req, String project, JsonProject input) throws BadRequestException, InternalErrorException, NotFoundException;
